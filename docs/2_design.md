...
![]({{"/assets/design/sketch1.png" | absolute_url }})
...
![]({{"/assets/design/sketch2.png" | absolute_url }})

> Early interface concept with simple dice rolling in the bottom right corner.

![]({{"/assets/design/sketch14.png" | absolute_url }})
...
![]({{"/assets/design/sketch9.png" | absolute_url }})

> Initial concept of how auto-complete would work.

![]({{"/assets/design/sketch23.png" | absolute_url }})
...
![]({{"/assets/design/sketch22.png" | absolute_url }})
...
![]({{"/assets/design/sketch10.png" | absolute_url }})

> Early concept of the combat toolbar.

![]({{"/assets/design/sketch12.png" | absolute_url }})

> Early concept of the character toolbar.

![]({{"/assets/design/sketch16.png" | absolute_url }})

> Further iteration of the combat toolbar including automatic initiative ordering.

![]({{"/assets/design/sketch17.png" | absolute_url }})
...
![]({{"/assets/design/sketch25.png" | absolute_url }})

> Concept of the combat widget in the reference view.

![]({{"/assets/design/sketch26.png" | absolute_url }})

> Moving the combat toolbar to the bottom in order to save horizontal space.

![]({{"/assets/design/sketch27.png" | absolute_url }})

> Wider bottom toolbar.

![]({{"/assets/design/sketch28.png" | absolute_url }})
...
![]({{"/assets/design/sketch30.png" | absolute_url }})
...
![]({{"/assets/design/sketch31.png" | absolute_url }})
...
![]({{"/assets/design/sketch32.png" | absolute_url }})
...
![]({{"/assets/design/sketch38.png" | absolute_url }})
